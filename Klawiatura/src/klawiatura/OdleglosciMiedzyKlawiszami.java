...
public class OdleglosciMiedzyKlawiszami {
    ...
    /**
     * zwraca rząd klawisza
     */
    public int dajRzad(String znak) {
    ...
    /**
     * zwraca pozycję w rzędzie
     */
    public int dajPozycjeWRzedzie(String znak) {
        int tmp = pierwszy.dajPozycję(znak);
        if (tmp != -1) {
            return tmp;
        } else {
    ...
    /**
     * przechowuje numer rzędu i pozycję klawisza oraz daje różniceę między
     * klawiszami
     */
